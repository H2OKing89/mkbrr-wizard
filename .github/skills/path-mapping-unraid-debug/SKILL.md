...
2. Trace conversion through `map_content_path()` and `map_torrent_path()` in `src/mkbrr_wizard/legacy_app.py`, then inspect how `src/mkbrr_wizard/planning/planner.py` records the resolved forms.
