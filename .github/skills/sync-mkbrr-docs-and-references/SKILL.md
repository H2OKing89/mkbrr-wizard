...
3. Compare changed docs against shared builders and prompts in `src/mkbrr_wizard/legacy_app.py`, strict fields in `batch_models.py`, and headless options in `cli.py`.
